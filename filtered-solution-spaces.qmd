...
A function $f$ is said to be integer convex if the following holds. For vectors $x$ and $d$ in $\mathbb{Z}^T$, we have
...
print(f"Best schedule found: {x_star} with objective value {c_star}")
```