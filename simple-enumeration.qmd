...
# v_star_matrix, and s_dist are assumed to be the same as for the first figure,
# as per "All else equal". The compute_schedules_and_objectives function will use 
# the updated N_patients and the existing T_intervals, s_dist, etc. from the global scope.
